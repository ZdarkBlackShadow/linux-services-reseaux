...
### Vous devrez ensuite suivre les paramètres d'installation classiques (comme sur une VM VirtualBox). ![setup](./images/Setup1.png)
...
Confirm : ![setup summary](./images/Setup2.png)
...
Vous devriez voir cette page : ![Hardware](./images/Hardware.png)
